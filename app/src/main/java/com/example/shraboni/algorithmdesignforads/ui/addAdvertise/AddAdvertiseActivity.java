...
//        if (s <= target)
//            probableAddList.add(partial);
//        Log.i("ShowResults", "probableAddList_sizes.................... "+probableAddList.size());
//        if (s >= target)
//            return;
//        for(int i=0;i<numbers.size();i++) {
...
//        if (s <= target)
//            probableAddList.add(partial);
//        Log.i("probableAddList", "sum_up_recursive:....... "+probableAddList.size());
//        if (s >= target)
//            return;
//        for(int i=0;i<numbers.size();i++) {
//            ArrayList<Advertise> remaining = new ArrayList<>();
...
import java.util.Arrays;
    ...
    public class AddAdvertiseActivity extends AppCompatActivity {
        ...
        void ShowResults(){
            ...
            Advertise a = new Advertise("a",3);
            Advertise b = new Advertise("b",9);
            Advertise c = new Advertise("c",8);

            Advertise d = new Advertise("d",4);
            Advertise e = new Advertise("e",5);
            Advertise f = new Advertise("e",10);
            ...
            addList.add(e);
            addList.add(f);
            for (Advertise add:addList) {
                Log.i("bleh", "ShowResults: ....... "+add.toString());
            }
            ...
            /*for (int i = 0; i < probableAddList.size(); i++) {
                //if (noOfAdds == probableAddList.get(i).size()) {
                    for (int j = 0; j < probableAddList.get(i).size(); j++) {
                       // broadCast = broadCast + probableAddList.get(i).get(j).getAddname();
                        Log.i("bleh", "for: ....... "+Arrays.toString(probableAddList.get(i).toArray()));
                        Log.i("bleh", "ShowResults: ..................... "+probableAddList.get(i).get(j).getTime());
